class VideosController < ApplicationController
    ...
    def index
        @videos = Video.search(params[:genre],params[:new_released])
        if @videos.empty?
    ...
    def video_params
        ...
        params.require(:video).permit(:title, :description, :image_url, :released_year, genre_ids: [], genres_attributes: [:title])
    end
